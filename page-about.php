...
<div id="about">
	<div class="outcover"></div>
	<div class="container">
	<div class="text-center">
		<span class="arrow" navcue="">↑</span>
	</div>
		<div class="portfolio-img col-sm-12 text-center">
			<img src="<?php bloginfo('template_directory'); ?>/img/johan.png" class="img-circle img-responsive center-block">
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="portfolio-content col-sm-12">
			...
			<div class="sport-two">
				...
				<img src="<?php bloginfo('template_directory'); ?>/img/tidning.jpg" class="img-responsive center-block">
				<p class="text-justify">
					Från en tidig ålder har jag hållit på att skriva, skapa och utveckla mig själv i all dess form som kan definieras som galet eller kreativt. Min skolgång var som en evig berg- och dalbana som aldrig tyckets ta slut. Frånvarande i skolbänken sittandes hemma med alla vänner som man hade mött online vågade vi göra det vi själva tyckte var roligt. Idiotiskt i många ögon, till en viss del kan jag hålla med om detta. Det var bara så mycket roligare och framför allt så mycket mer givande, ni anar inte hur mycket man faktiskt lärde sig av att dela sin kunskap med andra. Jag gjorde det jag gillade helt enkelt. Något jag fortfarande gillar. Visst är det konstigt?
				</p>
				<p class="text-justify">
					Sommaren 2011 ansökte jag med mina klena betyg och min stolta tidning till högskolan i Hultsfred. Där jag skulle få lära mig mer om det jag älskar att göra, webbutveckling och webbdesign. Konstigt nog blev jag antagen.
				</p>
				<p class="text-justify">
					I slutändan handlar allting om att göra saker. Från att vara en fattig student till en framgångsrik entreprenör. Från ingenting till att skapa något för andra människor, en värdefull lösning. Att kunna se ett behov eller ett problem och kunna förstå, se processen i en helhet och kunna bidra till en lösning, är för mig vad kreativitet handlar om.
				</p>
				<p class="text-center">
